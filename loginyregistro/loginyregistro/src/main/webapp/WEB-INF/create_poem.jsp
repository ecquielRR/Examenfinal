...
<head>
    ...
    <title>Añadir Nuevo Poema</title>
...
<body>
    <div class="container">
        <h1 class="text-4xl font-extrabold text-gray-900 mb-8 text-center">Añadir Nuevo Poema</h1>

        <div class="form-card">
            <form:form action="${pageContext.request.contextPath}/procesar/agregar/poema" method="post" modelAttribute="poema"> <%-- CORREGIDO: action y modelAttribute --%>
                <div class="mb-5">
                ...
                <div class="flex justify-end space-x-4">
                    ...
                    <button type="submit" class="btn-primary shadow-md">Guardar Poema</button>
                </div>
            </form:form>
        </div>
    </div>
