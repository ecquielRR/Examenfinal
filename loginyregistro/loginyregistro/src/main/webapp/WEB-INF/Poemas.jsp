...
<body>
    <div class="container">
        <h1 class="main-title">Todos los Poemas</h1>
        ...
        <c:choose>
            <c:when test="${empty listaDePoemas}">
                <div class="text-center text-gray-600 text-lg py-10">
                    <p>No hay poemas disponibles en este momento. ¡Sé el primero en añadir uno!</p>
                        ...
                        <div class="poem-card">
                            ...
                            <div class="card-actions">
                                <%-- Solo mostrar botones de editar/eliminar si el poema pertenece al usuario logueado
                                     Esto requiere que el modelo Poemas tenga un campo 'usuario' y que el ID del usuario logueado esté en sesión.
                                     Si no quieres esta lógica aquí, puedes eliminar la condición. --%>
