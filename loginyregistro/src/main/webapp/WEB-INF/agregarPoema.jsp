...
<head>
    ...
    <title>Agregar Nuevo Poema</title>
...
<body>
    <div class="container">
        <h1 class="main-title">Agregar Nuevo Poema</h1>

        <%-- Mensajes de éxito y error (si los hubiera) --%>
        ...
        <div class="form-card">
            <%-- Formulario para agregar un poema. El modelAttribute "poema" debe coincidir con el nombre usado en el controlador --%>
            <form:form action="${pageContext.request.contextPath}/procesar/agregar/poema" method="post" modelAttribute="poema">
                <div class="campo">
                ...
                <div class="action-buttons">
                    ...
                    <button type="submit" class="btn-primary">Guardar Poema</button>
                </div>
            </form:form>
        </div>
    </div>
